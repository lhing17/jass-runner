...
function periodic_report takes nothing returns nothing
    call DisplayTextToPlayer(Player(0), 0, 0, "Periodic report: All systems operational")
endfunction
...
function main takes nothing returns nothing
    ...
    call DisplayTextToPlayer(Player(0), 0, 0, "Starting simulation...")

    // 创建一个单位
    set unit_name = "Hero_001"
    call DisplayTextToPlayer(Player(0), 0, 0, "Creating unit: " + unit_name)
    ...
    call DisplayTextToPlayer(Player(0), 0, 0, "Timers started. Simulation running...")
endfunction
